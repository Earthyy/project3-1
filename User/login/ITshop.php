...
<body style="background-color:#FAF3F0;">
    ...
    <div class="w3-container" >
        <div class="w3-content" >
                <div class="w3-display-container" style="max-width:100%; margin:10% 0 0 0;">
                    <div id="reccomend" style="max-height:550px; background-color:white;">
                        <img class="mySlides" src="ipadair5.jpg" style="width:100%;  object-fit:cover; height:550px; background-color:#;"">
                        <img class="mySlides" src="Asustuff15.jpeg" style="max-width:100%;  object-fit:cover; height:550px; text-aling:center; margin:auto;">
                        <img class="mySlides" src="iphone13.jpg" style="max-width:100%;  object-fit:cover; height:550px; text-aling:center; margin:auto;">
                            ...
                            <div class="w3-display-container">
                                <div class="w3-card-4" style="margin:0 12px 0 12px; ">
                                    ...
                                    <div class="w3-display-middle w3-display-hover">
                                        <a href="detailproduct.php?id=<?php echo $data_1['ProductID']; ?>" target="_blank" rel="noopener noreferrer" class="w3-button w3-black">View</a>
                                    </div>
